...
% We can demonstrate that this is true by repeating the above process.
...
% less students have less reliable estimates.
...
% height of the students in the university. This is all you have.
nStudents.class2      = 12;
measuredHeight.class2 = height.mean + height.sd*randn(nStudents.class2,1); 
estimatedMean         = mean(measuredHeight.class2);

% Now you can ask the question: "OK I have this mean, how much should 
% I trust it?" The level of trust really depends (among many things) 
...
% OK we can go on and notice that everytime we resample we have a slgihtly
...
plot([height.mean height.mean],[0 560],'ko--')

% You can see now that the red distribution under estimates the mean and
% covers a wide range of potential means. This is because the original
% sample was small - only 12 measurements. Collecting more measurements
...
% sense of the strength of evidence about your claim. Where you claim 
